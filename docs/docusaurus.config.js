...
const config = createConfig({
  title: 'OpenKlant',
  tagline: 'Nextcloud ExApp packaging for the VNG OpenKlant customer-registry standard. Sidecar Python service, JSON-RPC bridge, integrated with OpenRegister.',
  url: 'https://openklant.conduction.nl',
  baseUrl: '/',

  organizationName: 'ConductionNL',
  projectName: 'openklant',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://codeberg.org/Conduction/openklant/src/branch/main/docs/',
        },
        blog: false,
        theme: {
  ...
  navbar: {
    items: [
      ...
      {
        href: 'https://codeberg.org/Conduction/openklant',
        label: 'Codeberg',
        position: 'right',
      },
